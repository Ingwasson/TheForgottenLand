...
NCountry = {
	...
	MIGRATION_BOOST_BANTU = 150,						-- How many points given to bantu tribes when migrating.
	MIGRATION_COOLDOWN = 60,						-- How many months until next migration is possible.
	MIGRATION_COOLDOWN_BANTU = 180,						-- How many months until next migration is possible for bantu tribes.
